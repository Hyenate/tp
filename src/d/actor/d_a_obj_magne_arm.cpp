...
int daObjMarm_c::Create() {
    ...
    field_0xA04 = -l_trans[mMoveType];
    if (mMoveType == 0x3 || mMoveType == 0x1) {
        field_0xA04 = 0;
    }

    if (mMoveType == 0x1 || mMoveType == 0x3) {
        field_0xA09 = -1;
        field_0xA08 = 1;
    } else {
        field_0xA09 = 1;
...
int daObjMarm_c::CreateHeap() {
    ...
    field_0x5CC = new dBgW();
    if (field_0x5CC == NULL || field_0x5CC->Set((cBgD_t*)dComIfG_getObjectRes(l_arcName, 22),
                                                cBgW::MOVE_BG_e, &field_0x5D0))
    {
        field_0x5CC = NULL;
        return FALSE;
    }
    ...
    field_0x630 = new dBgW();
    if (field_0x630 == NULL || field_0x630->Set((cBgD_t*)dComIfG_getObjectRes(l_arcName, 23),
                                                cBgW::MOVE_BG_e, &field_0x634))
    {
        field_0x630 = NULL;
        return FALSE;
    }
    ...
    field_0xA20 = new mDoExt_3DlineMat1_c();
    field_0xA24 = new mDoExt_3DlineMat1_c();
    if (field_0xA20 == NULL || field_0xA24 == NULL) {
        return FALSE;
    }

    if (!field_0xA20->init(1, field_0xA28, (ResTIMG*)dComIfG_getObjectRes(l_arcName, 26), 1)) {
        return FALSE;
    }

    if (!field_0xA24->init(1, field_0xA29, (ResTIMG*)dComIfG_getObjectRes(l_arcName, 26), 1)) {
        return FALSE;
    }
...
cPhs__Step daObjMarm_c::phase_2() {
    ...
    if(actor != NULL) {
        ...
        if(fopAcM_isSwitch(this, getSwNo(this))) {
            actor->setOn();
        }
...
int daObjMarm_c::Execute(Mtx** i_bgMtx) {
    ...
    *i_bgMtx = &mBgMtx;
    ...
    if(actor != NULL) {
        ...
        mDoMtx_stack_c::YrotS(current.angle.y + mYRot1 + mYRot2);
        mDoMtx_stack_c::ZrotM(mFPartsZRot);
        mDoMtx_stack_c::multVec(&offset, &offset);
        f_parts_offset += offset;
        actor->home.pos = f_parts_offset;
        actor->current.pos = f_parts_offset;
        actor->shape_angle.y = current.angle.y + mYRot1 + mYRot2;
        actor->shape_angle.z = mFPartsZRot;
    }
    mYRot2 = field_0xA2C * cM_ssin(field_0x9F4 * 8000);
    mFPartsOffsetZRot = field_0xA2C * cM_ssin(field_0x9F4 * 4000);
...
void daObjMarm_c::action() {
    ...
    switch(mMoveType) {
        case 0:
            (this->*l_func_typeA[field_0xA14])();
            break;

        case 1:
            (this->*l_func_typeB[field_0xA14])();
            break;

        case 2:
            (this->*l_func_typeC[field_0xA14])();
            break;

        case 3:
            (this->*l_func_typeD[field_0xA14])();
            break;
    }
}
...
void daObjMarm_c::typeA_modeRotate() {
    ...
    if(cLib_calcTimer(&field_0xA17) == 0) {
        ...
        cLib_addCalcAngleS(&field_0xA0A, rot_speedY, 20, 50, 10);
        mBPartsXRot -= field_0xA0A;
        field_0xA10 += abs(field_0xA0A);
        if(field_0xA10 > 0x4000) {
            setMagneHoleEffect();
            field_0xA08 += field_0xA09;
            if(field_0xA08 == 0) {
                field_0xA09 = 1;
            }
            else if(field_0xA08 == 2) {
                field_0xA09 = -1;
            }
            field_0xA2C = 150.0f;
            field_0xA3C = 800.0f;
...
void daObjMarm_c::typeB_modeLiftUp() {
    if(cLib_calcTimer(&field_0xA17) == 0) {
        cLib_addCalcAngleS(&field_0xA0C, l_roll_speed[1], 20, 50, 10);
        mDPartsXRot += field_0xA0C;
        field_0xA04 += field_0xA0C * 1884.9557f / 65536.0f;
        if(field_0xA04 > 0.0f) {
            field_0xA04 = 0.0f;
            init_typeB_modeRotate();
        }
...
void daObjMarm_c::typeB_modeLiftDown() {
    if(cLib_calcTimer(&field_0xA17) == 0) {
        ...
        mDPartsXRot -= field_0xA0C;
        field_0xA04 -= field_0xA0C * 1884.9557f / 65536.0f;
        if(field_0xA04 < -l_trans[mMoveType]) {
            field_0xA04 = -l_trans[mMoveType];
...
void daObjMarm_c::typeC_modeLiftUp() {
    if(cLib_calcTimer(&field_0xA17) == 0) {
        cLib_addCalcAngleS(&field_0xA0C, l_roll_speed[2], 20, 50, 10);
        mDPartsXRot += field_0xA0C;
        field_0xA04 += field_0xA0C * 1884.9557f / 65536.0f;
        if(field_0xA04 > 0.0f) {
            field_0xA04 = 0.0f;
...
void daObjMarm_c::typeD_modeLiftUp() {
    if(cLib_calcTimer(&field_0xA17) == 0) {
        cLib_addCalcAngleS(&field_0xA0C, l_roll_speed[3], 20, 50, 10);
        mDPartsXRot += field_0xA0C;
        field_0xA04 += field_0xA0C * 1884.9557f / 65536.0f;
        if(field_0xA04 > 0.0f) {
            field_0xA04 = 0.0f;
...
void daObjMarm_c::calcHimo() {
    ...
    cXyz* line_mat1_pos = field_0xA20->getPos(0);
    *line_mat1_pos = offset1;
    ...
    line_mat1_pos = field_0xA24->getPos(0);
...
int daObjMarm_c::Draw() {
    ...
    field_0xA20->update(field_0xA28, 25.5f, color, 0, &tevStr);
    dComIfGd_set3DlineMat(field_0xA20);
    field_0xA24->update(field_0xA29, 25.5f, color, 0, &tevStr);
    dComIfGd_set3DlineMat(field_0xA24);
    ...
    if(fopAcM_gc_c::gndCheck(&offset1)) {
        ...
        mShadowKey = dComIfGd_setShadow(mShadowKey, 0, mpModel[5], &offset1, 
            1500.0f, 450.0f, offset1.y, ground_y, fopAcM_gc_c::mGndCheck, 
...
int daObjMarm_c::Delete() {
    if(field_0x5CC != NULL && field_0x5CC->ChkUsed() != NULL) {
        dComIfG_Bgsp().Release(field_0x5CC);
    }

    if(field_0x630 != NULL && field_0x630->ChkUsed() != NULL) {
        dComIfG_Bgsp().Release(field_0x630);
    }
    endMagneHoleEffect();
